...
s_config = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'configs', 'individual_9kpt.py')
...
# For mouse9, center=spine_front=3, so use 'nose' (Snout) for heading direction
NOSE_IDX = skeleton_module.SOCIAL_INDICES[SKELETON_NAME]['nose']
...
# 9kpt predictions can have NaN frames — interpolate before rotation
